...
public class Blackjack {
    public static void main(String[] args) {
        Deal player = new Deal(2);
        Deal dealer = new Deal(2);
        ...
        do {
            ...
            System.out.println();
            if (dealer.getScore() < 14 && player.getScore() <= 21) {
                do {
                    dealer.hit();
                    System.out.println();
                ...
                while (dealer.getScore() < 14 && player.getScore() <= 21);
            }
    ...
    public static void calculateWinnings(int playerMoney) {
